...
with col:
    st.image("https://img1.baidu.com/it/u=4210670833,2619333922&fm=253&fmt=auto&app=120&f=GIF?w=380&h=380",width=335)
    flag = st.button("JC-T绘言",use_container_width=True)
    if flag:
        st.switch_page("pages/demo03.py")
with col1:
    st.image("https://img1.baidu.com/it/u=1911613735,2891783689&fm=253&fmt=auto&app=120&f=GIF?w=380&h=380", width=335)
    flag1 = st.button("JC-T绘图",use_container_width=True)
    if flag1:
        st.switch_page("pages/textToimage.py")
with col2:
    st.image("https://img1.baidu.com/it/u=1911613735,2891783689&fm=253&fmt=auto&app=120&f=GIF?w=380&h=380", width=335)
    flag1 = st.button("JC-T智能",use_container_width=True)
    if flag1:
        st.switch_page("pages/textToimage.py")
